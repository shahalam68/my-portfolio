  ...
  return (
    <section className="min-h-screen flex flex-col justify-center pt-36 pb-12 xl:pt-32 xl:pb-20">
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-3xl xl:text-5xl font-black text-white uppercase tracking-tighter">
            Services<span className="text-accent">.</span>
          </h2>
          <p className="text-white/40 text-base font-medium max-w-xl mx-auto">
            Transforming complex requirements into elegant, high-performance digital solutions.
          </p>
          <div className="w-16 h-1 bg-accent mx-auto rounded-full opacity-50"></div>
        </motion.div>
